...
export default class RPlayerConf {
    constructor() {
        ...
        this.conf = {
            app: {
                name: "RPlayer",
                version: "0.19.34", // <some platform updates>.<visible or control updates>.<unvisible updates>
                date:    "2022",
                preferences: {
                    transport: {
                        stepTime: .5 // [s]
                        ...
                        info: {
                            ...
                            anyHtml: {
                                0: {
                                    id: "Vocals",
                                    html: 
                                    "<a href=\"https://instagram.com/nolanmateer\" target=\"_blank\">Nolan Mateer<i class=\"instagram icon\" style=\"display: inline-block; padding: 0 !important;\"></i></a>and a girl who didn't want to be published...<br><br>" +
                        ...
                        info: {
                            ...
                            anyHtml: {
                                0: {
                                    id: "Vocal",
                                    html: 
                                    "<a href=\"https://www.instagram.com/marcelbrianiarts/\" target=\"_blank\">Marcel Briani<i class=\"instagram icon\" style=\"display: inline-block; padding: 0 !important;\"></i></a><br><br>" +
                                    "<img src=\"./media/images/www.instagram.com_marcelbrianiarts.png\">"
                                },
                                1: {
                                    id: "Song tempo",
                                    html: "175BPM",
