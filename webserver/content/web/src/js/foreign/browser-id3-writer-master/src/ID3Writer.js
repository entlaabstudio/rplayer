import {encodeWindows1252, encodeUtf16le} from './encoder.js';
import {getMimeType, isId3v2} from './signatures.js';
import {uint7ArrayToUint28, uint28ToUint7Array, uint32ToUint8Array} from './transform.js';
import {
    getNumericFrameSize,
    getStringFrameSize,
    getPictureFrameSize,
